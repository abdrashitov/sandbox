    ...
    <div className={styles.wrapper}>
      <div>
        ...
        <div className={styles.navy}>
          <span onClick={() => setDatepicker(1)} data-active={datepicker === 1}>
            Null
          </span>
          <span onClick={() => setDatepicker(2)} data-active={datepicker === 2}>
            Value
          </span>
          <span onClick={() => setDatepicker(3)} data-active={datepicker === 3}>
            MaxDate
          </span>
          <span onClick={() => setDatepicker(4)} data-active={datepicker === 4}>
            MinDate
          </span>
        </div>
